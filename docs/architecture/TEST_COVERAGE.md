...
| `catalog/durable-path.ts`             | `nc-app.test.tsx`, `durable-path.test.ts`, `path-c.test.tsx`, `nc-observer.test.ts`, `handle-intent.test.ts`, `llm-handler.test.ts`, `observation.test.ts`, `nc-renderer.test.tsx`, `context.test.ts` |
...
| `renderer/read-only-store.ts`         | `read-only-store.test.ts`                                                                                                                                                                             |
...
| ------------------------------------------ | ------------------- |
| `app/nc-app.test.tsx`                      | 16 files            |
| `catalog/durable-path.test.ts`             | 1 files             |
...
| `integration/path-c.test.tsx`              | 14 files            |
| `memory/projection.test.ts`                | 1 files             |
| `observer/nc-headless-components.test.ts`  | 1 files             |
| `observer/nc-observer.test.ts`             | 7 files             |
| `orchestrator/anthropic-transport.test.ts` | 2 files             |
| `orchestrator/buffer-isolation.test.ts`    | 0 files             |
| `orchestrator/handle-intent.test.ts`       | 6 files             |
| `orchestrator/llm-handler.test.ts`         | 15 files            |
| `orchestrator/observation.test.ts`         | 6 files             |
| `renderer/field-id-stability.test.ts`      | 1 files             |
| `renderer/input-components.test.tsx`       | 1 files             |
| `renderer/nc-renderer.test.tsx`            | 9 files             |
| `renderer/read-only-store.test.ts`         | 1 files             |
| `renderer/use-committed-tree.test.tsx`     | 1 files             |
| `runtime/context.test.ts`                  | 6 files             |
